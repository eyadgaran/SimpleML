...
class ThresholdForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.thresholds, self.false_omission_rate, maximize=False
        )
...
class ThresholdInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.thresholds, self.informedness, maximize=True
        )
...
class FprForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_positive_rate, self.false_omission_rate, maximize=False
        )
...
class FprInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_positive_rate, self.informedness, maximize=True
        )
...
class TprForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.true_positive_rate, self.false_omission_rate, maximize=False
        )
...
class TprInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.true_positive_rate, self.informedness, maximize=True
        )
...
class TnrForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.true_negative_rate, self.false_omission_rate, maximize=False
        )
...
class TnrInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.true_negative_rate, self.informedness, maximize=True
        )
...
class FnrForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_negative_rate, self.false_omission_rate, maximize=False
        )
...
class FnrInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_negative_rate, self.informedness, maximize=True
        )
...
class FdrForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_discovery_rate, self.false_omission_rate, maximize=False
        )
...
class FdrInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_discovery_rate, self.informedness, maximize=True
        )
...
class ForInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_omission_rate, self.informedness, maximize=True
        )
...
class ForMarkednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.false_omission_rate, self.markedness, maximize=True
        )
...
class PpvForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.positive_predictive_value, self.false_omission_rate, maximize=False
        )
...
class PpvInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.positive_predictive_value, self.informedness, maximize=True
        )
...
class NpvForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.negative_predictive_value, self.false_omission_rate, maximize=False
        )
...
class NpvInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.negative_predictive_value, self.informedness, maximize=True
        )
...
class PredictedPositiveRateForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.predicted_positive_rate, self.false_omission_rate, maximize=False
        )
...
class PredictedPositiveRateInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.predicted_positive_rate, self.informedness, maximize=True
        )
...
class PredictedNegativeRateForMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.predicted_negative_rate, self.false_omission_rate, maximize=False
        )
...
class PredictedNegativeRateInformednessMetric(BinaryClassificationMetric):
    ...
    def score(self):
        self.values = self.dedupe_curve(
            self.predicted_negative_rate, self.informedness, maximize=True
        )
