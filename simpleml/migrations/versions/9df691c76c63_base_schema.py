...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('filepaths', simpleml.orm.sqlalchemy_types.MutableJSON, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('feature_metadata', simpleml.orm.sqlalchemy_types.MutableJSON, nullable=True),
        sa.Column('pipeline_id', simpleml.orm.sqlalchemy_types.GUID(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
    ...
    with op.batch_alter_table("metrics") as batch_op:
        batch_op.create_foreign_key(
            "metrics_model_id_fkey", "models", ["model_id"], ["id"], ondelete="CASCADE"
        )
