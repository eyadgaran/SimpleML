...
class BaseDaskDataset(Dataset):
    ...
    def concatenate_dataframes(
        dataframes: List[ddDataFrame], split_names: List[str]
    ) -> ddDataFrame:
        """
        ...
        LOGGER.warning(
            "Dask concatenate does not reset index -- this could cause selection issues later. Use at your own discretion"
        )
