...
class SklearnPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    in case of downstream inplace mutations
    ...
    def dataset_params(self):
        return {
            "label_columns": ["c"],
            "other_named_split_sections": {"other": ["e"]},
            "squeeze_return": True,
        }
    ...
    def build_dataset(self):
        return self.dataset_cls.concatenate_dataframes(
            dataframes=[
                pd.DataFrame(
                    [{"a": 1, "b": 2, "c": 3, "e": 5}, {"a": 2, "b": 3, "c": 4, "e": 6}]
                ),
                pd.DataFrame(
                    [{"a": 3, "b": 4, "c": 5, "e": 7}, {"a": 4, "b": 5, "c": 6, "e": 8}]
                ),
                pd.DataFrame(
                    [
                        {"a": 5, "b": 6, "c": 7, "e": 9},
...
class ExplicitSplitSklearnPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class RandomSplitSklearnPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            X=pd.DataFrame(
                [{"a": 4, "b": 5}, {"a": 5, "b": 6}, {"a": 2, "b": 3}], index=[3, 4, 1]
            ),
...
class SklearnPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitSklearnPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            X=pd.DataFrame([{"a": 1, "b": 2}, {"a": 2, "b": 3}]),
            y=pd.DataFrame([{"c": 3, "d": 4}, {"c": 4, "d": 5}]),
            other=pd.DataFrame([{"e": 5}, {"e": 6}]),
        )
...
class RandomSplitSklearnPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            y=pd.DataFrame(
                [{"c": 6, "d": 7}, {"c": 7, "d": 8}, {"c": 4, "d": 5}], index=[3, 4, 1]
            ),
            other=pd.DataFrame([{"e": 8}, {"e": 9}, {"e": 6}], index=[3, 4, 1]),
        )
...
class OrderedDictPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitOrderedDictPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class RandomSplitOrderedDictPipelineSingleLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class OrderedDictPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitOrderedDictPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class RandomSplitOrderedDictPipelineMultiLabelPandasDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class SklearnPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            y=dd.from_pandas(
                pd.Series([3, 4, 5, 6, 7, 8], name="c"), npartitions=5, sort=True
            ),
            other=dd.from_pandas(
                pd.Series([5, 6, 7, 8, 9, 10], name="e"), npartitions=5, sort=True
            ),
        )
    ...
    def build_dataset(self):
        ...
        return dd.from_pandas(
            BasePandasDataset.concatenate_dataframes(
                dataframes=[
                    pd.DataFrame(
                        [
                            {"a": 1, "b": 2, "c": 3, "e": 5},
...
class ExplicitSplitSklearnPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            y=dd.from_pandas(pd.Series([3, 4], name="c"), npartitions=5, sort=True),
            other=dd.from_pandas(pd.Series([5, 6], name="e"), npartitions=5, sort=True),
        )
...
class RandomSplitSklearnPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            y=dd.from_pandas(
                pd.Series([6, 7, 4], index=[3, 4, 1], name="c"),
                npartitions=5,
                sort=True,
            ),
            other=dd.from_pandas(
                pd.Series([8, 9, 6], index=[3, 4, 1], name="e"),
                npartitions=5,
                sort=True,
            ),
        )
...
class SklearnPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitSklearnPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            y=dd.from_pandas(
                pd.DataFrame([{"c": 3, "d": 4}, {"c": 4, "d": 5}]),
                npartitions=5,
                sort=True,
            ),
            other=dd.from_pandas(
                pd.DataFrame([{"e": 5}, {"e": 6}]), npartitions=5, sort=True
            ),
        )
...
class RandomSplitSklearnPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
    ...
    def expected_split_contents(self):
        return Split(
            ...
            other=dd.from_pandas(
                pd.DataFrame([{"e": 8}, {"e": 9}, {"e": 6}], index=[3, 4, 1]),
                npartitions=5,
                sort=True,
            ),
        )
...
class OrderedDictPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitOrderedDictPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class RandomSplitOrderedDictPipelineSingleLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class OrderedDictPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class ExplicitSplitOrderedDictPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
...
class RandomSplitOrderedDictPipelineMultiLabelDaskDatasetSplitTests(
    _PipelineSplitTests, unittest.TestCase
):
    """
    Pandas datasets are able to return copies of splits
