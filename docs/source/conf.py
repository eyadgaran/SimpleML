...
project = u'SimpleML'
copyright = u'2018, Elisha Yadgaran'
author = u'Elisha Yadgaran'
...
latex_documents = [
    (master_doc, 'SimpleML.tex', u'SimpleML Documentation',
     u'Elisha Yadgaran', 'manual'),
]
...
man_pages = [
    (master_doc, 'simpleml', u'SimpleML Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SimpleML', u'SimpleML Documentation',
     author, 'SimpleML', 'One line description of project.',
     'Miscellaneous'),
]
